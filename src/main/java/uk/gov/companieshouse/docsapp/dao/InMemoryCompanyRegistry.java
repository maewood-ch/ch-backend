...
@Component //this annotation tells Spring to create an instance of the class defined below and inject it into the Spring context.
// you can then use @Autowired to access the instance inside your controller.
@ConditionalOnProperty(name = "companieshouse.docsapp.test", havingValue = "true")
